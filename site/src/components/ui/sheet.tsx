      ...
      <SheetViewport side={side} variant={variant}>
        <SheetPrimitive.Popup
          className={cn(
            ...
            side === "left" &&
              "w-[calc(100%-(--spacing(6)))] max-w-md border data-ending-style:-translate-x-8 data-starting-style:-translate-x-8 sm:w-[calc(100%-(--spacing(12)))] sm:border-e",
            side === "right" &&
              "col-start-2 w-[calc(100%-(--spacing(6)))] max-w-md border data-ending-style:translate-x-8 data-starting-style:translate-x-8 sm:w-[calc(100%-(--spacing(12)))] sm:border-s",
            variant === "inset" &&
              "before:hidden rounded-[1.75rem] before:rounded-[calc(var(--radius-3xl)-1px)] **:data-[slot=sheet-footer]:rounded-b-[calc(var(--radius-3xl)-1px)]",
            className,
          )}
